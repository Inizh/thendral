...
//  2026-01-19: DirectX11: Added 'SamplerNearest' in ImGui_ImplDX11_RenderState.
//  Renamed 'SamplerDefault' to 'SamplerLinear'. 2025-09-18: Call
//  platform_io.ClearRendererHandlers() on shutdown. 2025-06-11: DirectX11:
//  Added support for ImGuiBackendFlags_RendererHasTextures, for dynamic font
//  atlas. 2025-05-07: DirectX11: Honor draw_data->FramebufferScale to allow for
//  custom backends and experiment using it (consistently with other renderer
//  backends, even though in normal condition it is not set under Windows).
//  2025-01-06: DirectX11: Expose VertexConstantBuffer in
//  ImGui_ImplDX11_RenderState. Reset projection matrix in
//  ImDrawCallback_ResetRenderState handler. 2024-10-07: DirectX11: Changed
