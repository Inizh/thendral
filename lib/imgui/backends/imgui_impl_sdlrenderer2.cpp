...
// Note that SDL_Renderer is an _optional_ component of SDL2, which IMHO is now
// largely obsolete. For a multi-platform app consider using other technologies:
// - SDL3+SDL_GPU: SDL_GPU is SDL3 new graphics abstraction API. You will need
// to update to SDL3.
// - SDL2+DirectX, SDL2+OpenGL, SDL2+Vulkan: combine SDL with dedicated
...
//  dynamic font atlas. Removed ImGui_ImplSDLRenderer2_CreateFontsTexture() and
//  ImGui_ImplSDLRenderer2_DestroyFontsTexture(). 2025-01-18: Use
//  endian-dependent RGBA32 texture format, to match SDL_Color. 2024-10-09:
//  Expose selected render state in ImGui_ImplSDLRenderer2_RenderState, which
//  you can access in 'void* platform_io.Renderer_RenderState' during draw
//  callbacks. 2024-05-14: *BREAKING CHANGE*
//  ImGui_ImplSDLRenderer3_RenderDrawData() requires SDL_Renderer* passed as
//  parameter. 2023-05-30: Renamed imgui_impl_sdlrenderer.h/.cpp to
//  imgui_impl_sdlrenderer2.h/.cpp to accommodate for upcoming SDL3. 2022-10-11:
...
static ImGui_ImplSDLRenderer2_Data* ImGui_ImplSDLRenderer2_GetBackendData() {
	return ImGui::GetCurrentContext()
			   ? (ImGui_ImplSDLRenderer2_Data*)ImGui::GetIO()
		...
		for (int cmd_i = 0; cmd_i < draw_list->CmdBuffer.Size; cmd_i++) {
			...
			if (pcmd->UserCallback) {
				...
				SDL_RenderGeometryRaw(
					renderer, tex, xy, (int)sizeof(ImDrawVert), color,
