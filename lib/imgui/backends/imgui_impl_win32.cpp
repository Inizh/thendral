...
//  2025-12-03: Inputs: handle WM_IME_CHAR/WM_IME_COMPOSITION messages to
//  support Unicode inputs on MBCS (non-Unicode) Windows. (#9099, #3653, #5961)
//  2025-10-19: Inputs: Revert previous change to allow for io.ClearInputKeys()
//  on focus-out not losing gamepad state. 2025-09-23: Inputs: Minor
//  optimization not submitting gamepad input if packet number has not changed.
//  2025-09-18: Call platform_io.ClearPlatformHandlers() on shutdown.
//  2025-04-30: Inputs: Fixed an issue where externally losing mouse capture
//  (due to e.g. focus loss) would fail to claim it again the next subsequent
//  click. (#8594) 2025-03-10: When dealing with OEM keys, use scancodes instead
//  of translated keycodes to choose ImGuiKey values. (#7136, #7201, #7206,
//  #7306, #7670, #7672, #8468) 2025-02-18: Added ImGuiMouseCursor_Wait and
//  ImGuiMouseCursor_Progress mouse cursor support. 2024-07-08: Inputs: Fixed
//  ImGuiMod_Super being mapped to VK_APPS instead of VK_LWIN||VK_RWIN. (#7768)
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandlerEx(HWND hwnd, UINT msg,
	...
	switch (msg) {
		...
		case WM_NCMOUSEMOVE: {
			...
			if (msg ==
				WM_NCMOUSEMOVE)	 // WM_NCMOUSEMOVE are absolute coordinates.
