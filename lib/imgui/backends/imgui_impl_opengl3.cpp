...
//  2025-12-11: OpenGL: Fixed embedded loader multiple init/shutdown cycles
//  broken on some platforms. (#8792, #9112) 2025-09-18: Call
//  platform_io.ClearRendererHandlers() on shutdown. 2025-07-22: OpenGL: Add and
//  call embedded loader shutdown during ImGui_ImplOpenGL3_Shutdown() to
//  facilitate multiple init/shutdown cycles in same process. (#8792)
//  2025-07-15: OpenGL: Set GL_UNPACK_ALIGNMENT to 1 before updating textures
//  (#8802) + restore non-WebGL/ES update path that doesn't require a CPU-side
//  copy. 2025-06-11: OpenGL: Added support for
