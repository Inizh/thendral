...
// Usage:
// - Add '#define IMGUI_ENABLE_FREETYPE' in your imconfig to automatically
// enable support
//   for imgui_freetype in imgui. It is equivalent to selecting the default
//   loader with:
//      io.Fonts->SetFontLoader(ImGuiFreeType::GetFontLoader())

// Optional support for OpenType SVG fonts:
// - Add '#define IMGUI_ENABLE_FREETYPE_PLUTOSVG' to use plutosvg (not
// provided). See #7927.
// - Add '#define IMGUI_ENABLE_FREETYPE_LUNASVG' to use lunasvg (not provided).
// See #6591.
...
// Microsoft's rasterizer. You can set those flags globally in
// ImFontAtlas::FontLoaderFlags You can set those flags on a per font basis in
...
// - prefer deep-copying this into your own ImFontLoader instance if you use
...
// Obsolete names (will be removed)
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
// IMGUI_API const ImFontBuilderIO* GetBuilderForFreeType(); // Renamed/changed
// in 1.92. Change 'io.Fonts->FontBuilderIO =
// ImGuiFreeType::GetBuilderForFreeType()' to
// 'io.Fonts->SetFontLoader(ImGuiFreeType::GetFontLoader())' if you need runtime
// selection. static inline bool BuildFontAtlas(ImFontAtlas* atlas, unsigned int
// flags = 0) { atlas->FontBuilderIO = GetBuilderForFreeType();
// atlas->FontLoaderFlags = flags; return atlas->Build(); } // Prefer using
