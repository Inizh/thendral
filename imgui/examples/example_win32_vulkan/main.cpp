...
int main(int, char**) {
	...
	HWND hwnd = ::CreateWindowW(
		wc.lpszClassName, L"Dear ImGui Win32+Vulkan Example",
	...
	if (vkCreateWin32SurfaceKHR(g_Instance, &createInfo, nullptr, &surface) !=
		VK_SUCCESS) {
	...
	SetupVulkanWindow(wd, surface, (int)(1280 * main_scale),
					  (int)(800 * main_scale));
