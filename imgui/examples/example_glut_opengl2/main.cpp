// Dear ImGui: standalone example application for GLUT/FreeGLUT + OpenGL2, using
...
int main(int argc, char** argv) {
	...
	// We will also call ImGui_ImplGLUT_InstallFuncs() to get all the other
	// functions installed for us, otherwise it is possible to install our own
	// functions and call the imgui_impl_glut.h functions ourselves.
	...
	// glutPassiveMotionFunc(), glutMouseFunc(), glutKeyboardFunc() etc.) You
	// can read the io.WantCaptureMouse, io.WantCaptureKeyboard flags to tell if
