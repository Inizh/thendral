...
int main(int, char**) {
	...
	SDL_Window* window =
		SDL_CreateWindow("Dear ImGui SDL2+WebGPU example",
						 SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
						 wgpu_surface_width, wgpu_surface_height, window_flags);
	if (window == nullptr) {
...
// (2025/10/31) there is no "official" support in SDL2 to create a surface for
// WebGPU backend. This stub uses "low level" SDL2 calls to acquire information
