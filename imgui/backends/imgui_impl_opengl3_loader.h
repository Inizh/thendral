...
GLAPI void APIENTRY glGetVertexAttribiv(GLuint index, GLenum pname,
										GLint *params);
...
static int open_libgl(void) {
	...
	wgl_get_proc_address =
		(GL3WglGetProcAddr)GetProcAddress(libgl, "wglGetProcAddress");
	return GL3W_OK;
}
...
static int open_libs(void) {
	...
	// While most systems use libGL.so.1, NetBSD seems to use that libGL.so.3.
	// See https://github.com/ocornut/imgui/issues/6983
