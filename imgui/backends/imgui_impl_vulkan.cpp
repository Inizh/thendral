...
//  2025-09-26: [Helpers] *BREAKING CHANGE*: Vulkan: Helper
//  ImGui_ImplVulkanH_DestroyWindow() does not call vkDestroySurfaceKHR(): as
//  surface is created by caller of ImGui_ImplVulkanH_CreateOrResizeWindow(), it
//  is more consistent that we don't destroy it. (#9163) 2026-01-05: [Helpers]
//  *BREAKING CHANGE*: Vulkan: Helper for creating render pass uses
...
//  cap.supportedCompositeAlpha. (#8784) 2025-10-15: Vulkan: Added
...
//  (#8585) 2025-09-18: Call platform_io.ClearRendererHandlers() on shutdown.
...
void ImGui_ImplVulkanH_CreateWindowSwapChain(
	...
	if (wd->UseDynamicRendering == false) {
		...
		// want to create one with: ImGui_ImplVulkan_CreatePipeline(device,
		// allocator, VK_NULL_HANDLE, wd->RenderPass, VK_SAMPLE_COUNT_1_BIT,
		// &wd->Pipeline, v->Subpass);
	}
