...
static void ImGui_ImplDX11_SetupRenderState(const ImDrawData* draw_data,
  ...
  if (device_ctx->Map(bd->pVertexConstantBuffer, 0, D3D11_MAP_WRITE_DISCARD, 0,
  ...
  device_ctx->HSSetShader(nullptr, nullptr,
                          0);  // In theory we should backup and restore this as
                               // well.. very infrequently used..
...
void ImGui_ImplDX11_UpdateTexture(ImTextureData* tex) {
  ...
  if (tex->Status == ImTextureStatus_WantCreate) {
    ...
    for (ImTextureRect& r : tex->Updates) {
      ...
      bd->pd3dDeviceContext->UpdateSubresource(backend_tex->pTexture, 0, &box,
