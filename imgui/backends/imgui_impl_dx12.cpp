...
//  2025-10-11: DirectX12: Reuse texture upload buffer and grow it only when
//  necessary. (#9002) 2025-09-29: DirectX12: Rework synchronization logic.
//  (#8961) 2025-09-29: DirectX12: Enable swapchain tearing to eliminate
//  viewports framerate throttling. (#8965) 2025-09-29: DirectX12: Reuse a
//  command list and allocator for texture uploads instead of recreating them
//  each time. (#8963) 2025-09-18: Call platform_io.ClearRendererHandlers() on
//  shutdown. 2025-06-19: Fixed build on MinGW. (#8702, #4594) 2025-06-11:
//  DirectX12: Added support for ImGuiBackendFlags_RendererHasTextures, for
//  dynamic font atlas. 2025-05-07: DirectX12: Honor draw_data->FramebufferScale
//  to allow for custom backends and experiment using it (consistently with
//  other renderer backends, even though in normal condition it is not set under
//  Windows). 2025-02-24: DirectX12: Fixed an issue where ImGui_ImplDX12_Init()
//  signature change from 2024-11-15 combined with change from 2025-01-15 made
//  legacy ImGui_ImplDX12_Init() crash. (#8429) 2025-01-15: DirectX12: Texture
//  upload use the command queue provided in ImGui_ImplDX12_InitInfo instead of
...
bool ImGui_ImplDX12_Init(ImGui_ImplDX12_InitInfo* init_info) {
	...
	bd->pFrameResources =
		new ImGui_ImplDX12_RenderBuffers[bd->numFramesInFlight];
